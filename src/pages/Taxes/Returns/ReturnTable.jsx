...
const ReturnTable = ({ activeProducts, customers }) => {
      ...
      <Row className='customer__table num'>
        <Col span={24}>
              ...
              return (
                <Row>
                  <Col
                    ...
                    md={{ span: 5 }}
                    sm={{ span: 7 }}
                    xs={isMobile ? { span: 11 } : { span: 8 }}
                    className='table__header1'
                  >
                    <Select
                      defaultValue='filedAndPaid'
                      onChange={handleChange}
                      className='num'
                      style={styles.tableHeader}
                    >
                      <Option value='all'>{t('Taxes.All_returns')}</Option>
                      <Option value='open'> {t('Taxes.Open')}</Option>
                      <Option value='filed'> {t('Taxes.Filed')}</Option>

                      <Option value='filedAndPaid'>
                        {' '}
                        {t('Taxes.Filed_and_paid')}
                      </Option>
                    </Select>
                  </Col>
          ...
          >
            <Column
              title={
                <span style={styles.firstRow}>
                  {t('Taxes.Form.Amount_due').toUpperCase()}
                </span>
              }
            ...
            <Column
              title={t('Taxes.Form.File_date').toUpperCase()}
              dataIndex='file_date'
              key='file_date'
              className='table-col'
              // width={150}
            />
            <Column
              title={t('Taxes.Form.Amount_due').toUpperCase()}
            ...
            />
            <Column
              title={t('Sales.Customers.Details.Payment').toUpperCase()}
              dataIndex='payments'
              key='payments'
              className='table-col'
              // width={150}
