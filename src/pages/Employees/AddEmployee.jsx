...
const AddEmployee = (props) => {
  ...
  const handleOk = (e) => {
    ...
    form.validateFields().then(async (value) => {
      ...
      // );
      // const hireDate = await ChangeJalaliDateToGregorian(
      //   value["hireDate"] && value["hireDate"].format("YYYY-MM-DD")
      // );
      // const releasedDate = await ChangeJalaliDateToGregorian(
      //   value["released"] && value["released"].format("YYYY-MM-DD")
      // );
