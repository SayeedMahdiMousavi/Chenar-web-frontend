...
import Email from './Invoice/Email';
import {
  // Layout,
  Drawer,
  Form,
...
import Design from './Invoice/Design';
import {
  BankTwoTone,
  PlusCircleOutlined,
  // UploadOutlined,
...
import Logos from './Invoice/Logos';
import Content from './Invoice/Content';
...
const Invoice = (props) => {
  ...
  return (
    <div>
      <div onClick={showDrawer}>{t('Sales.Customers.Details.Invoice')}</div>
      <Drawer
        maskClosable={false}
        mask={true}
                ...
                <Col span={24}>
                  ...
                  >
                    <Radio.Button value='content'>
                      {' '}
                      {t('Custom_form_styles.Content')}
                    </Radio.Button>
                    <Radio.Button value='design'>
                      {' '}
                      {t('Custom_form_styles.Design')}
                    </Radio.Button>

                    <Radio.Button value='emails'>
                      {' '}
                      {t('Custom_form_styles.Emails')}
                    </Radio.Button>
                  </Radio.Group>
                </Col>
                {current === 'design' ? (
                    ...
                    <Row gutter={[0, 40]}>
                      ...
                      {editPrintSetting ? (
                        <Col span={24}>
                          <Row gutter={20}>
                            <Col span={24}>
                              {' '}
                              <Text strong={true}>
                                {t('Custom_form_styles.Page_margins ')}
                              </Text>
                            </Col>
                            <Col span={5}>
                              <Form.Item
                                label={t('Custom_form_styles.Top')}
                                name='top'
                            ...
                            <Col span={5}>
                              {' '}
                              <Form.Item
                                label={t('Custom_form_styles.Right')}
                                name='right'
                            ...
                            <Col span={5}>
                              <Form.Item
                                label={t('Custom_form_styles.Bottom')}
                                name='bottom'
                            ...
                            <Col span={5}>
                              {' '}
                              <Form.Item
                                label={t('Custom_form_styles.Left')}
                                name='left'
                            ...
                            <Col span={24}>
                              <Form.Item name='fitWindow' style={styles.margin}>
                                <Checkbox
                                  ...
                                  style={styles.margin}
                                >
                                  {t('Custom_form_styles.Fit_window')}
                                </Checkbox>
                              </Form.Item>
                            </Col>{' '}
                          </Row>{' '}
                        ...
                        >
                          ...
                          <div className='show_logo_pdf'>
                            {' '}
                            {t('Custom_form_styles.Edit_print_settings')}
                          </div>
                        </Col>
                      )}
                    </Row>
                      ...
                      <Row>
                        ...
                        <Col span={24}>
                          ...
                          <Form.Item name='showCompanyNo' style={styles.margin}>
                            ...
                            >
                              {t('Custom_form_styles.Company_no')}
                            </Checkbox>
                          </Form.Item>
                        </Col>
                        <Col span={16}>
                        ...
                        <Col span={24}>
                          ...
                          >
                            <Checkbox
                              ...
                              // checked={companyNoShow}
                            >
                              {t('Custom_form_styles.Business_address')}
                            </Checkbox>
                          </Form.Item>
                        </Col>
                        <Col span={24}>
                          <Divider />
                          <Text strong={true}>{t('Form.1')}</Text>
                        </Col>
                        <Col span={24}>
                          <Form.Item name='formNames' style={styles.margin}>
                            <Checkbox
                              ...
                              checked={formNames}
                            >
                              {t('Custom_form_styles.Form_names')}
                            </Checkbox>
                          </Form.Item>
                        </Col>
                        {formNames && (
                          <Row>
                            ...
                            <Col span={14}>
                              ...
                              <Form.Item
                                name='invoice'
                                label={t('Sales.Customers.Details.Invoice')}
                                style={styles.margin}
                                className='edit_fields_pdf'
                              >
                                <Input />
                            ...
                            <Col span={14}>
                              ...
                              <Form.Item
                                name='taxInvoice'
                                label={t('Custom_form_styles.Tax_invoice')}
                                style={styles.margin}
                                className='edit_fields_pdf'
                              >
                        ...
                        <Col span={24}>
                          <Form.Item name='formNumber' style={styles.margin}>
                            <Checkbox
                              ...
                              checked={formNumber}
                            >
                              {t('Custom_form_styles.Form_numbers')}
                            </Checkbox>
                          </Form.Item>
                        </Col>
                        <Col span={24}>
                        ...
                        <Col span={24}>
                          <Form.Item name='customerNo' style={styles.custom}>
                            <Checkbox
                              ...
                              checked={customerNo}
                            >
                              {t('Custom_form_styles.Customer_VAT_number')}
                            </Checkbox>
                          </Form.Item>
                        </Col>
                        <Col span={14} style={{ display: 'flex' }}>
                          ...
                          >
                            <Input
                              placeholder={t('Custom_form_styles.Custom')}
