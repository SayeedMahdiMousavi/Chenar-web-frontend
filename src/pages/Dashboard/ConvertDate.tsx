...
export default function ConvertDate() {
  ...
  const button = (
    <Button
      ...
      type='primary'
      block
      style={{ borderRadius: '5px', backgroundColor: Colors.primaryColor, marginTop: '10px', padding: '15px 10px' }}
      htmlType='submit'
    >
      {t('Date.Convert')}
    </Button>
  ...
  return (
    ...
    >
      <Space direction='vertical' size='small'>
        <Typography.Text strong={true} style={{ fontSize: '14px', color: mode === 'dark' ? Colors.white : "black " }}>
          ...
          >
            ...
            <TabPane tab={t('Date.Jallali')} key='1' >
              ...
              <Descriptions
                ...
                column={1}
                size='small'
                style={{ marginTop: '10px', color: mode === 'dark' ? Colors.white : "white" }}
              >
            <Descriptions.Item
              label={<span style={{ color: mode === 'dark' ? 'white' : '#aaa' }}>{t('Date.Gregory')}</span>}
            >
              <span style={{ color: mode === 'dark' ? 'white' : 'black' }}>
                {Boolean(jToGregory) ? jToGregory : defaultDate?.gregory?.date}
              </span>
            </Descriptions.Item>

            <Descriptions.Item
              label={<span style={{ color: mode === 'dark' ? 'white' : '#aaa' }}>{t('Date.Lunar')}</span>}
            >
              <span style={{ color: mode === 'dark' ? 'white' : 'black' }}>
            ...
            <TabPane tab={t('Date.Gregory')} key='2'>
              ...
              <Descriptions column={1} size='small' style={{ marginTop: '10px' }}>
                <Descriptions.Item
                  label={<span style={{ color: mode === 'dark' ? 'white' : '#aaa' }}>{t('Date.Jallali')}</span>}
                >
                  <span style={{ color: mode === 'dark' ? 'white' : 'black' }}>
                    {Boolean(gToJallali) ? gToJallali : defaultDate?.jallali?.date}
                  </span>
                </Descriptions.Item>
            ...
            <TabPane tab={t('Date.Lunar')} key='3'>
              ...
              <Descriptions column={1} size='small' style={{ marginTop: '10px' }}>
                ...
                >
                  <span style={{ color: mode === 'dark' ? 'white' : 'black' }}>
                    {Boolean(tToGregory) ? tToGregory : defaultDate?.gregory?.date}
                  </span>
                </Descriptions.Item>
               </Descriptions>
