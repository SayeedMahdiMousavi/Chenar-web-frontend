    ...
    (data: any) => invoiceService.createSalesInvoice(data),
    {
      onSuccess: (invoice) => {
        queryClient.invalidateQueries({
          queryKey: [{ queryKey: ['invoices', 'sales'] }],
        });
        queryClient.invalidateQueries({
          queryKey: [{ queryKey: ['dashboard'] }],
        });
        message.success(
          `Sales invoice ${invoice.invoice_number} created successfully`,
        );
      },
      onError: () => {
...
export const useCreatePurchaseInvoice = () => {
  ...
  return useGenericMutation(
    (data: any) => invoiceService.createPurchaseInvoice(data),
    {
      onSuccess: (invoice) => {
        queryClient.invalidateQueries({
          queryKey: [{ queryKey: ['invoices', 'purchase'] }],
        });
        queryClient.invalidateQueries({
          queryKey: [{ queryKey: ['dashboard'] }],
        });
        message.success(
          `Purchase invoice ${invoice.invoice_number} created successfully`,
        );
      },
      onError: () => {
      ...
      invoiceService.updatePurchaseInvoice(id, data),
    {
      onSuccess: (invoice, variables) => {
        ...
        queryClient.setQueryData(
          ['invoices', 'purchase', variables.id],
          invoice,
        );
...
export const useCreateSalesOrder = () => {
  ...
  return useGenericMutation(
    (data: any) => invoiceService.createSalesOrder(data),
    {
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: [{ queryKey: ['orders', 'sales'] }],
        });
  ...
  return useGenericMutation(
    (id: string | number) => invoiceService.convertSalesOrderToInvoice(id),
    {
      onSuccess: (invoice) => {
        ...
        message.success(
          `Sales order converted to invoice ${invoice.invoice_number}`,
        );
      },
      onError: () => {
...
export const useCreatePurchaseOrder = () => {
  ...
  return useGenericMutation(
    (data: any) => invoiceService.createPurchaseOrder(data),
    {
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey: [{ queryKey: ['orders', 'purchase'] }],
        });
  ...
  return useGenericMutation(
    (id: string | number) => invoiceService.convertPurchaseOrderToInvoice(id),
    {
      onSuccess: (invoice) => {
        ...
        message.success(
          `Purchase order converted to invoice ${invoice.invoice_number}`,
        );
      },
      onError: () => {
...
export const useCreateEstimate = () => {
  ...
  return useGenericMutation(
    (data: any) => invoiceService.createEstimate(data),
    {
      onSuccess: (estimate) => {
        queryClient.invalidateQueries({
          queryKey: [{ queryKey: ['estimates'] }],
        });
        message.success(
          `Estimate ${estimate.estimate_number} created successfully`,
        );
      },
      onError: () => {
  ...
  return useGenericMutation(
    (id: string | number) => invoiceService.convertEstimateToInvoice(id),
    {
      onSuccess: (invoice) => {
        ...
        message.success(
          `Estimate converted to invoice ${invoice.invoice_number}`,
        );
      },
      onError: () => {
  ...
  return useGenericMutation(
    (data: any) => invoiceService.createProductTransfer(data),
    {
      onSuccess: (transfer) => {
        ...
        message.success(
          `Product transfer ${transfer.transfer_number} created successfully`,
        );
      },
      onError: () => {
  ...
  return useGenericMutation(
    (data: any) => invoiceService.createProductAdjustment(data),
    {
      onSuccess: (adjustment) => {
        queryClient.invalidateQueries({
          queryKey: [{ queryKey: ['adjustments'] }],
        });
        queryClient.invalidateQueries({
          queryKey: [{ queryKey: ['inventory'] }],
        });
        message.success(
          `Product adjustment ${adjustment.adjustment_number} created successfully`,
        );
      },
      onError: () => {
