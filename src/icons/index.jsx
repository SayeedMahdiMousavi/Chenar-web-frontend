...
export const SidebarIcon = ({ style, icon: IconComponent, ...rest }) => {
  return (
    <IconComponent style={{ ...styles.sidebarIcon, ...style }} {...rest} />
  );
};

// Card Icon Component
export const CardIcon = ({ style, icon: IconComponent, ...rest }) => {
  return <IconComponent style={{ ...styles.cardIcon, ...style }} {...rest} />;
};
...
export const DollarIcon = (props) => (
  <SidebarIcon icon={FaDollarSign} {...props} />
);
export const WalletIcon = (props) => <SidebarIcon icon={FaWallet} {...props} />;
export const ShoppingCartIcon = (props) => (
  <SidebarIcon icon={FaShoppingCart} {...props} />
);
export const CreditCardIcon = (props) => (
  <SidebarIcon icon={FaCreditCard} {...props} />
);
export const CalculatorIcon = (props) => (
  <SidebarIcon icon={FaCalculator} {...props} />
);
export const JournalBookIcon = (props) => (
  <SidebarIcon icon={RiBookLine} {...props} />
);

export const IncomeIcon = (props) => (
  <CardIcon icon={GiReceiveMoney} {...props} />
);
export const PayableAccountIcon = (props) => (
  <CardIcon icon={GiPayMoney} {...props} />
);
export const ReceivableAccountIcon = (props) => (
  <CardIcon icon={GiReceiveMoney} {...props} />
);
export const MastercardIcon = (props) => (
  <CardIcon icon={RiMastercardFill} {...props} />
);

export const ExpandIcon = (props) => (
  <MainIcon icon={MdExpandMore} {...props} />
);
export const CollapseIcon = (props) => (
  <MainIcon icon={MdExpandLess} {...props} />
);
export const SunIcon = (props) => <MainIcon icon={MdSunny} {...props} />;
export const MoonIcon = (props) => <MainIcon icon={LuSunMoon} {...props} />;
export const BellIcon = (props) => (
  <MainIcon icon={MdNotifications} {...props} />
);
export const SwapIcon = (props) => <MainIcon icon={MdSwapHoriz} {...props} />;
export const UserFillIcon = (props) => (
  <MainIcon icon={BsFillPersonFill} {...props} />
);
export const LockFillIcon = (props) => (
  <MainIcon icon={BsFillLockFill} {...props} />
);
export const CalendarFillIcon = (props) => (
  <MainIcon icon={BsFillCalendarFill} {...props} />
);
export const GlobalFillIcon = (props) => <MainIcon icon={BsGlobe} {...props} />;
export const TickIcon = (props) => (
  <MainIcon icon={AiFillCheckCircle} {...props} />
);
export const CloseIcon = (props) => (
  <MainIcon icon={AiFillCloseCircle} {...props} />
);
export const EditIcon = (props) => <MainIcon icon={AiFillEdit} {...props} />;
export const DeleteIcon = (props) => (
  <MainIcon icon={AiFillDelete} {...props} />
);
export const SaveIcon = (props) => <MainIcon icon={AiFillSave} {...props} />;
export const CircularArrowIcon = (props) => (
  <MainIcon icon={BiTransfer} {...props} />
);
export const DotsIcon = (props) => (
  <MainIcon icon={BiDotsHorizontalRounded} {...props} />
);
...
export const ViewIcon = (props) => (
  <MainIcon icon={MdOutlinePreview} {...props} />
);
...
export const AirPayIcon = (props) => (
  <CardIcon icon={FaMoneyBillWave} {...props} />
);
