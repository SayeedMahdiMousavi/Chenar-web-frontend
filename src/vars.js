export const dark = {
  '@theme': 'dark',
  '@popover-background': ' #282E33',
  '@popover-customize-border-color': ' #3a3a3a',
  '#ffffff': '#18191D',

  '#d9d9d9': ' #434343', // base border outline a component
  '#f0f0f0': ' #303030', // split border inside a component

  // Tree
  // ---
  '@tree-bg': ' transparent',
  // "@tree-node-selected-bg": " #e6f7ff",
  ...
  '@shadow-1-down':
    ' 0 6px 16px -8px rgba(0, 0, 0, 0.32), 0 9px 28px 0 rgba(0, 0, 0, 0.2),  0 12px 48px 16px rgba(0, 0, 0, 0.12)',
  '@shadow-1-right':
    ' 6px 0 16px -8px rgba(0, 0, 0, 0.32), 9px 0 28px 0 rgba(0, 0, 0, 0.2),  12px 0 48px 16px rgba(0, 0, 0, 0.12)',
  '@shadow-2':
  ...
  // "@table-selected-row-color": "@black",
...
export const lightThemeVars = {
  ...
  '@text-color': '#727272',
  // "@font-family": "IRAN_YEKAN_REGULAR",
